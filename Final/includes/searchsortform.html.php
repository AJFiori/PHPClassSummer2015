...
<div class="row">
 ...
 <td>
        <form method="post" action="#">
                <select name="selected_address_group" class="form-control" style="width: 135px">
                <?php                
...
<td>                
        <form method="post" action="#">
                <select name="selected_search_index" class="form-control" style="width: 135px">
                <?php                
            ...
            <br>
            <input type="text" name="search_field" value="" placeholder="<?php if(isset($searchField)) {echo $searchField;} else {echo "Search";}?>" class="form-control" style="width: 145px" />
                <br>
...
<td> 
        ...
        <form method="post" action="#">
                <select name="selected_sort_index" class="form-control" style="width: 135px">
                <?php                
